...
export const evts_calendrier: GroupeEvts = {
    evts: [
            ...
            },
            {
                ...
                conditions: (perso:Perso):boolean => perso.mois === enumMois.brumaire && perso.jourDuMois === 1,
            },
            {
                id: "calendrier3",
                description: async (_perso: Perso): Promise<string> => {
            ...
            {
                id: "calendrier5",
                description: async (_perso: Perso): Promise<string> => "Aujourd'hui c'est sonnstill, le jour du solsctice d'été, le plus long jour de l'année ! " +
            ...
            {
                id: "calendrier6",
                description: async (_perso: Perso): Promise<string> => "Aujourd'hui c'est geheiminstag, le jour des mystères. " +
                ...
                conditions: (perso:Perso):boolean => perso.mois === enumMois.messidor,
            },
            {
                id: "calendrier7",

                description: async (_perso: Perso): Promise<string> => "Nous sommes en pleine semaine de la tourte hobbit. " +
                ...
                conditions: (perso:Perso):boolean => perso.mois === enumMois.fructidor && perso.jourDuMois >= 1 && perso.jourDuMois <= 8,
            },
    ],
    probaParDefaut: 10,
};